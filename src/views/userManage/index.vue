  ...
  <div class="app-container flex flex-row">
    <div class="tree-container">
      ...
      <div class="flex-1 pr-2 pb-2 overflow-y-auto overflow-x-hidden">
        <el-tree ref="treeRef" node-key="id" :data="levelTreeData" :props="defaultProps"
          :filter-node-method="filterNode" highlight-current accordion @node-click="handleNodeClick" class="h-full">
        </el-tree>
      </div>
    </div>
    <div class="w0px flex-1 flex flex-col">
      ...
      <div class="flex justify-between items-center mt-2">
        ...
        <div>
          <el-input v-model="filterText" placeholder="请输入用户名" clearable class="mr-2" suffix-icon="Search" />
        </div>
      </div>
          ...
          <el-row :gutter="4">
            <el-col :span="5">
              <el-form-item label="父组织">
                <el-select v-model="searchForm.parentGroupId" placeholder="请选择父组织"></el-select>
              </el-form-item>
            </el-col>
            <el-col :span="5">
