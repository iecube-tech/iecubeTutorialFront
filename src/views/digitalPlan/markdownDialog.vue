<template>
  ...
  >
    <div class="md-wrapper">
      <div v-show="!props.isStream && canEidt" class="flex flex-row-reverse mb-2">
      ...
      <MdEditor
        ...
        previewTheme="github"
      ></MdEditor>
      <div ref="streamRef" v-show="props.isStream" class="w-full flex-1 overflow-x-hidden overflow-y-auto whitespace-pre-wrap break-words break-all">
        {{ markdownContent }}
      </div>
    </div>
    <template #footer>
